...
有关类型和原始值的更多信息，可查看 [JavaScript 数据结构](https://github.com/onlyxhb/javascript-guidebooke/blob/master/01_BasicConcept/1_Grammar&Types/3_DataStructures&Types.mdhttps://github.com/onlyxhb/javascript-guidebooke/blob/master/01_BasicConcept/1_Grammar&Types/3_DataStructures&Types) 页面。
